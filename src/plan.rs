...
- [x] tower-sessions + axum-login + sqlx session store (HttpOnly, SameSite=Strict, secure cookies)
- [x] User model activation + owner_id on zorbs table
...
Next priority:
1. Finish Phase 0: Passkeys (WebAuthn 2.0)
2. Official Zeta Standard Library polish
3. Dark Factory foundation
